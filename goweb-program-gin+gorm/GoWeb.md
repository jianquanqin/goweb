...
第三步，在main函数中启用并监听8080端口，并在浏览器中访问
...
### 1.7.9 text/template包和html/template包的区别
...
**2 将二进制文件上传至远程服务器tmp目录**

```
scp -r /Users/qinjianquan/goweb-program-gin+gorm root@47.100.202.97:/tmp
```

**3 查看Linux防火墙是否开启了相应的端口**
